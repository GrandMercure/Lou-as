...
export default function InventoryTable({ items, onRowClick }) {
  return (
    <div className="overflow-x-auto rounded-xl border border-mercure-border bg-white">
              ...
              <td className="px-4 py-3.5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-mercure-muted">{formatDate(item.ultimaAtualizacao)}</p>
                  </div>
                </div>
              </td>
              <td className="px-4 py-3.5 text-mercure-muted">{item.categoria}</td>
              <td className="px-4 py-3.5 text-right font-medium">{formatNumber(item.quantidadeTotal)}</td>
              <td className="px-4 py-3.5 text-right text-emerald-700">{formatNumber(item.disponivel)}</td>
              <td className="px-4 py-3.5 text-right text-red-600">{formatNumber(item.danificado)}</td>
              <td className="px-4 py-3.5">
